...
const BlogList = () => {
  ...
  const addFaq = () => {
    history.push(`/app/faqs/add-faq`);
  };

  const viewDetails = (row) => {
    history.push(`/app/faqs/edit-faq/${row.id}`);
  };
    ...
    confirm({
      ...
      async onOk() {
        try {
          ...
          await FaqService.delete(formdata);
